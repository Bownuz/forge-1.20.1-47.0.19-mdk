...
public class ModBiomes {
    public static final ResourceKey<Biome> WARPED_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(Fedde_MOD.MOD_ID, "warped_biome"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(WARPED_BIOME, slingbiome(context));
    }
    ...
    public static Biome slingbiome(BootstapContext<Biome> context) {
