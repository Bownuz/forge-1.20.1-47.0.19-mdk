package net.fedde.newmod.entity.custom;
...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            ...
            case PURPLE -> ModItems.PURPLE_BOAT.get();
        };
    }
    ...
    public static enum Type implements StringRepresentable {
        ...
        PURPLE(ModBlocks.PURPLE_PLANKS.get(), "purple");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            if (pName.equals("PINE")){
            return CODEC.byName(pName, PINE);
            }
            else {
                return CODEC.byName(pName, PURPLE);
            }
        }
    }
}